...
امیدوارم الان دربارهٔ نحوهٔ کار سیستم نوع JS بسیار آگاه‌تر شده باشید، از انواع مقدار اولیه تا انواع شیء، تا نحوهٔ انجام coercionهای نوع توسط موتور.

مهم‌تر، الان تصویر کامل‌تری از مزایا/معایب انتخاب‌هایی که با سیستم نوع JS می‌کنیم دارید، مثل انتخاب coercionهای *implicit* یا *explicit* در نقاط مختلف.

اما زمینهٔ عملکرد سیستم نوع را کاملاً پوشش ندادیم. برای بقیهٔ این کتاب، توجه خود را به قوانین نحو/دستور JS معطوف می‌کنیم که نحوهٔ رفتار عملگرها و عبارت‌ها را کنترل می‌کنند.
